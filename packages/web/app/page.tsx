...
export default function Home() {
  ...
  const security = [
    { icon: Shield, title: 'Smart Contracts Auditados', desc: 'Contratos verificados e auditados por terceiros' },
    { icon: Code2, title: 'Codigo Open Source', desc: 'Transparencia total com codigo aberto no GitHub' },
    { icon: Link2, title: 'Chainlink VRF', desc: 'Resultados comprovadamente justos' },
    { icon: Zap, title: 'Polygon Blockchain', desc: 'Taxas de centavos, velocidade de segundos' },
  ];
    ...
    <main className="scroll-smooth overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-4 bg-grid">
        ...
        >
          ...
          >
            Polygon PoS &bull; Chainlink VRF &bull; Revenue Share
          </motion.div>
      ...
      <section id="token-sale" className="relative min-h-screen flex flex-col items-center justify-center px-4 bg-grid">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold mb-4">
            <span className="gradient-text">Nao perca o lancamento</span>
          </h2>
          <p className="text-gray-400 text-lg mb-4">
            Garanta seus BETPASS antes que acabe
          </p>
